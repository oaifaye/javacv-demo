...
public class CopyOfStartOpenCv {
	...
	public static void main(String[] args) throws Throwable {
		...
		IplImage srclogo = cvLoadImage("e:/logo.png");
		IplImage srclogoMask = cvLoadImage("e:/logo.png",0);
		...
		FFmpegFrameRecorder recorder = new FFmpegFrameRecorder("rtmp://127.0.0.1/lr1/s2", WIDTH, HEIGHT, 1);
